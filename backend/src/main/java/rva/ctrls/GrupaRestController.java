...
public class GrupaRestController {
	...
	@GetMapping("grupa")
	@ApiOperation(value="Vraæa kolekciju svih grupa iz baze podataka")
	public Collection<Grupa> getGrupe(){
		return grupaRepository.findAll();
	}
	
	@GetMapping("grupa/{id}")
	@ApiOperation(value="Vraæa grupu na osnovu prosledjenog ID-ja iz baze podataka")
	public Grupa getGrupa(@PathVariable("id") Integer id) {
		return grupaRepository.getOne(id);
	}
	@GetMapping("grupaOznaka/{oznaka}")
	@ApiOperation(value="Vraæa kolekciju grupa na osnovu prosledjenog znaka iz baze podataka")
