...
public class StudentRestController {
	...
	@ApiOperation(value="Vraæa studenta na osnovu prosledjenog ID-ja iz baze podataka")
	public Student getStudent(@PathVariable("id") Integer id) {
		return studentRepository.getOne(id);
	}
	@GetMapping("studentGrupaID/{id}")
	@ApiOperation(value="Vraæa kolekciju studenata na osnovu prosledjenog ID-ja iz baze podataka")
	...
	@ApiOperation(value="Vraæa kolekciju svih studenata sa manjim ID-jem od prosledjenog iz baze podataka")
