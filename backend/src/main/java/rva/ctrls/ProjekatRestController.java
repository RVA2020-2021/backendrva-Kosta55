...
public class ProjekatRestController {
	//a
		...
		@GetMapping("projekat")
		@ApiOperation(value="Vraæa kolekciju svih projekata iz baze podataka")
		...
		@ApiOperation(value="Vraæa projekat na osnovu prosledjenog ID-ja iz baze podataka")
		public Projekat getProjekat(@PathVariable("id") Integer id) {
			return projekatRepository.getOne(id);
		}
		
		@GetMapping("projekatNaziv/{naziv}")
		@ApiOperation(value="Vraæa kolekciju projekata na osnovu unesenog stringa iz baze podataka")
